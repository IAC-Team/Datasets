...
print("The image has already been normolized!!")
h = np.shape(im)[0]
w = np.shape(im)[1]
iLR = copy.copy(im)
print("start mirror!!")
...
im = iLR
print("The image has already been mirrored!!")
raw = 0
column = 0
h = 0
l = 0
image_name = "quickbird2015_subset_"
savepath = "./IAC_data/dataset/mirror/"
savepath90 = "./IAC_data/dataset/mirror90/"
savepath270 = "./IAC_data/dataset/mirror270/"
savepath180 = "./IAC_data/dataset/mirror180/"
